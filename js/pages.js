...
var pageEvent = {
	...
	start: function start() {
		...
		var page1 = [{ en: '', cn: '', font: '', name: '' }, { en: 'Miss you.', cn: '我想你', font: '是我所有的偏爱', name: 'miss' }, { en: 'Care you.', cn: '在乎你', font: '在每一刻每一秒', name: 'care' }, { en: 'My. future.', cn: '陪伴你', font: '肩并肩手挽手', name: 'and' }, { en: 'Only you.', cn: '只有你', font: '是我跨越山河的理由', name: 'only' }, { en: 'Protect you.', cn: '守护你', font: '哪怕很多争争吵吵', name: 'protect' }, { en: 'Thank you.', cn: '感谢你', font: '给我一切一切最大的美好', name: 'thank' }];
		var html = '';
